...
//             <TouchableOpacity style={{ marginTop: 10 }}>
//               <Link href={`/list/${item.id}`}>
//                 <Text style={[styles.linkStyle]}>View Details</Text>
//               </Link>
//             </TouchableOpacity>
//             <TouchableOpacity >
//               <Link href={`/(tabs)/cart`}>
//                   <Text style={[styles.linkStyle]}>Add to Cart</Text>
//               </Link>
//             </TouchableOpacity>
//           </View>
//         )}
...
const Home = () => {
  ...
  const [sortOrder, setSortOrder] = useState<string>("none"); // For price sorting
  const [searchText, setSearchText] = useState<string>(""); // For search functionality
  const [cart, setCart] = useState<{ [key: number]: { product: Product; quantity: number } }>({}); // Cart state
